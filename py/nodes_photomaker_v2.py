...
from .photomaker.resampler import FacePerceiverResampler
from .photomaker.insightface_package import analyze_faces, FaceAnalysis2
...
class PhotoMakerEncodeV2:
    ...
    def apply_photomaker(self, photomakerv2, image, clip, text):
                ...
                if index > 0:
                    ...
                    for i, item in enumerate(t):
                        if item[2] == index - 1:
                            ...
                            break
                    if t_index >=0:
                        f = t[:t_index] + [class_token] * num_id_images*photomakerv2.num_tokens + t[t_index+1:]
                    else:
                        f = t
        ...
        if index > 0:
            ...
            class_tokens_mask = [True if token_index <= i < token_index+(num_id_images*photomakerv2.num_tokens) else False for i in range(cond.shape[1])]
